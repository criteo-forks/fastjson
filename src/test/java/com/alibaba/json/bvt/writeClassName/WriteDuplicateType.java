...
public class WriteDuplicateType extends TestCase {
    ...
    public void test_dupType2() throws Exception {
        ...
        String text1 = JSON.toJSONString(cartMap, SerializerFeature.WriteClassName);
        Assert.assertEquals("{\"@type\":\"java.util.LinkedHashMap\",\"1001\":{\"@type\":\"java.util.HashMap\",\"@@@type@@@\":\"com.alibaba.json.bvt.writeClassName.WriteDuplicateType$DianDianCart\",\"id\":1001}}", text1);
